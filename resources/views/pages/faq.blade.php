<div class="faq-q">
		...
		<div class="window-body">
			...
			<div class="contact-us">
				...
				<div class="contact">
					...
					<div class="contact__info">
						...
						<div class="contact-time">
							Average response time -<span style="color: #fff">5:00</span>
						</div>
			...
			<div class="help-q ui-accordion-header ui-corner-top ui-accordion-header-collapsed  ui-state-default ui-accordion-icons ui-corner-all" role="tab" id="ui-id-3" aria-controls="ui-id-4" aria-selected="false" aria-expanded="false" tabindex="-1"><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"></span><span class="ui-accordion-header-icon ui-icon ui-icon-triangle-1-e"></span>About the site</div>
				...
				<div class="help-a ui-accordion-content ui-corner-bottom ui-helper-reset ui-widget-content" id="ui-id-4" aria-labelledby="ui-id-3" role="tabpanel" aria-hidden="true" style="display: none;">
					Go to the page of any game, click on the button with the icon <i class="fas fa-info-circle tooltip" title="Информация о игре"></i>, a window with instructions for the game will open in front of you, then specify the amount of the bet and click "Play".
				</div>
				...
				<div class="help-a ui-accordion-content ui-corner-bottom ui-helper-reset ui-widget-content" id="ui-id-2" aria-labelledby="ui-id-1" role="tabpanel" aria-hidden="true" style="display: none;">
					...
					<p class="help-a__text">Subscribe to our group <a href="https://vk.com/{{$settings->vk_url}}" target="_blank" class="colored-link">vk.com/{{$settings->vk_url}}</a> or go to page <a href="javascript:void(0)" onclick="@if(Auth::guest()) $('#b_si').click(); @else load('/bonus'); @endif" class="colored-link">Bonuses</a>.</p>
					<div class="help-a__way">Method 2</div>
					<p class="help-a__text">Subscribe to our group <a href="https://vk.com/{{$settings->vk_url}}" target="_blank" class="colored-link">vk.com/{{$settings->vk_url}}</a>, where promo codes are published daily. You can activate the promo code in the "Promo code" tab on the page <a href="javascript:void(0)" onclick="@if(Auth::guest()) $('#b_si').click(); @else load('/bonus'); @endif" class="colored-link">Bonuses</a>.</p>
				...
				<div class="help-a ui-accordion-content ui-corner-bottom ui-helper-reset ui-widget-content" id="ui-id-34" aria-labelledby="ui-id-33" role="tabpanel" aria-hidden="true" style="display: none;">
					<p class="help-a__text">
						If the status of the withdrawal is "In Progress", you can cancel it in <a href="javascript:void(0)" onclick="$('#b_si').click();" class="colored-link">Profile</a> in the "Conclusions" tab in the "Status" column by clicking on the cancel button.
					</p>
				</div>
