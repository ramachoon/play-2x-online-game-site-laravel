    ...
    <div class="bonus_page_container">
        <div class="bonus_option" onclick="$('#wheel').toggleClass('md-show', true)">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description">Spin the free wheel with a bonus<br>every 3 minutes!</div>
    ...
    <div class="bonus_page_container">
        <div class="bonus_option" onclick="window.open('https://vk.com/bets.play2x')">
            <div class="bonus_option_content">
                ...
                <div class="bonus_option_description" style="margin-bottom: 64px;">Are you the administrator of the VKontakte group? We can offer daily unique promo codes for your group.</div>
                <div class="bonus_option_button">To contact us</div>
            </div>
        </div>
