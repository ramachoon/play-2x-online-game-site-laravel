            ...
            <div class="carousel-slide">
                ...
                <div class="carousel-content">
                    ...
                    <div class="slide-content">
                        ...
                        Come to our group VK -<a class="ll" href="https://vk.com/bankwin" target="_blank">Demo Hotbitmarket.com</a>
                    </div>
                </div>
        ...
        <div>
            <div class="carousel-slide">
                ...
                <div class="carousel-content">
                    ...
                    <div class="slide-content">
                        Experience the peak of social gambling,<br>combining the atmosphere of a real casino with the simplicity of your favorite game modes. 
                    </div>
                </div>
        ...
        <div>
            <div class="carousel-slide">
                ...
                <div class="carousel-content">
                    ...
                    <div class="slide-content">
                        Start from scratch to become richer and more successful<br>get a daily bonus up to 100 dollar to start earning real cash. 
                    </div>
                </div>
                <button class="slide-button" @if(Auth::guest()) onclick="$('#b_si').click();" @else onclick="load('/bonus')" @endif>Pick up bonus</button>
            </div>
        </div>
    </div> 
	@endif
	...
	<div class="welcome_Welcome__rQYTl">
            ...
            <img src="/img/Slide2.webp" loading="lazy" alt="" width="100%">
                ...
                <div class="welcome_Left__JPT6w">
                    ...
                    <div class="welcome_Intro__3Zo-O">Demo Hotbitmarket.com – Instant games with money withdrawal. The best licensed site for recreation and earnings (Demo For Sell).
                    </div>
					@php
                    ...
                    <div class="welcome_Counters__2BjGU">
                        ...
                        <div class="welcome_Item__3ifzJ">
                            <div class="welcome_Label__2pEjZ">Bred</div>{{$pw}} <i style="font-size: 19px;" class="far fa-Usdle-sign"></i></div>
                    </div>
                     <div class="welcome_Counters__2BjGU">
    ...
    <div class="col-xs-13 col-sm-6 col-md-5">
        <div class="i_game i_game-bonus" @if(!Auth::guest()) onclick="load('/bonus')" @else onclick="$('#b_si').click()" @endif>
            ...
            <div class="i_game-name bonus_banner_desc" id="bonus_banner_name">
                ...
                Get cash bonus<br>free to start playing on Bets HotBitmarket.com!
            </div>
        </div>
    </div>
